...
##
## Definition of model state variable rate of change parameters matrix
##
## Rows 1-6:   Age-dependent natural mortality.  According to the stock annex, these values are constants. How/where is that defined? What ensure these parameters are not also estimated?
##      7-11:  Von Bertalanfy growth parameters.
##      12-17: Weight-length, Maturity, Fecundity parameters.
##
#_growth_parms
...
##
## Spawner-recruitment parameters. (p. 98- in SS manual)
##
## For Beverton-Holt recruitment, we need: ln(R0), h (steepness), sigma_R (std of natural log rectruitment)
##
## We also need: SR_regime - base for adding time-varying adjustments. Should be 0.
##               SR_autocorr - autocorrelation in recruitment
##
...
-1 #_forecast_recruitment phase (incl. late recr) (0 value resets to maxphase+1)      ### DG: Negative value keeps the forecast recruitment deviations at a constant level
...
##
## "Catchability is the scaling factor that relates a model quantity to the expected value for some type of
##  data (index). Typically this is used to converted selected numbers or biomass for a fleet into the
##  expected value for a survey or CPUE by that fleet."
##
...
##
## Selectivity and discard, for fleet, acoustic and trapnet
##
## Size-selectivity: 0 = 1.0 for all sizes; 0 = no discard; 0 = no male specific selectivity; 0 = no special input
## Age-selectivity:  17 = random walk;      0 = no discard; 0 = no male specific selectivity; 0 = no special input
## 
...
### Fleet
  ...
  -5 	9 	 0.01 	-1 	-1 	0.01 	 -4 	0 0 0 0 0 0 0 # Change to age 7
